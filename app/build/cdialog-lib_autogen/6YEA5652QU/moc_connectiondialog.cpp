/****************************************************************************
** Meta object code from reading C++ file 'connectiondialog.hpp'
**
...
#error "The header file 'connectiondialog.hpp' doesn't include <QObject>."
...
static constexpr auto qt_meta_stringdata_CLASSConnectionDialogENDCLASS = QtMocHelpers::stringData(
    "ConnectionDialog",
    "GetIpAddress",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSConnectionDialogENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSConnectionDialogENDCLASS_t qt_meta_stringdata_CLASSConnectionDialogENDCLASS = {
    {
        QT_MOC_LITERAL(0, 16),  // "ConnectionDialog"
        QT_MOC_LITERAL(17, 12),  // "GetIpAddress"
        QT_MOC_LITERAL(30, 0)   // ""
    },
    "ConnectionDialog",
    "GetIpAddress",
